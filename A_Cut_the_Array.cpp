...
//     for(ll i=1;i<n;i++)
//     {
//         ll lf=accumulate(v.begin()+1,v.begin()+i+1,0);
//         for(ll j=i+1;j<n;j++)
//         {
//             ll m=accumulate(v.begin()+i+1,v.begin()+j+1,0);
